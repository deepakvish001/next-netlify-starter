...
Define the touch targets standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The touch targets requirement is observable and testable.
...
Keep implementation work focused on one touch targets outcome and record follow-up improvements separately.