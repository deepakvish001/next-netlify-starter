...
Define the test data standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The test data requirement is observable and testable.
...
Keep implementation work focused on one test data outcome and record follow-up improvements separately.