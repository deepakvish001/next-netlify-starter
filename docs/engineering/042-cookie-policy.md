...
Define the cookie policy standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The cookie policy requirement is observable and testable.
...
Keep implementation work focused on one cookie policy outcome and record follow-up improvements separately.