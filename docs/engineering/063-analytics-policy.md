...
Define the analytics policy standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The analytics policy requirement is observable and testable.
...
Keep implementation work focused on one analytics policy outcome and record follow-up improvements separately.