...
Define the page layout standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The page layout requirement is observable and testable.
...
Keep implementation work focused on one page layout outcome and record follow-up improvements separately.