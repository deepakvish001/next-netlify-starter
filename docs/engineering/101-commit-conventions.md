...
Define the commit conventions standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The commit conventions requirement is observable and testable.
...
Keep implementation work focused on one commit conventions outcome and record follow-up improvements separately.