...
Define the compatibility policy standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The compatibility policy requirement is observable and testable.
...
Keep implementation work focused on one compatibility policy outcome and record follow-up improvements separately.