...
Define the semantic landmarks standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The semantic landmarks requirement is observable and testable.
...
Keep implementation work focused on one semantic landmarks outcome and record follow-up improvements separately.