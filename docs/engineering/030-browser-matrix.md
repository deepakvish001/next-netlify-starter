...
Define the browser matrix standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The browser matrix requirement is observable and testable.
...
Keep implementation work focused on one browser matrix outcome and record follow-up improvements separately.