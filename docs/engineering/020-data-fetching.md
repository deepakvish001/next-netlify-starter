...
Define the data fetching standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The data fetching requirement is observable and testable.
...
Keep implementation work focused on one data fetching outcome and record follow-up improvements separately.