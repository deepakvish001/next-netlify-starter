...
Define the font loading standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The font loading requirement is observable and testable.
...
Keep implementation work focused on one font loading outcome and record follow-up improvements separately.