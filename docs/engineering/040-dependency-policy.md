...
Define the dependency policy standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The dependency policy requirement is observable and testable.
...
Keep implementation work focused on one dependency policy outcome and record follow-up improvements separately.