...
Define the reduced motion standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The reduced motion requirement is observable and testable.
...
Keep implementation work focused on one reduced motion outcome and record follow-up improvements separately.