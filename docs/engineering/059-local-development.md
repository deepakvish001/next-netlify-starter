...
Define the local development standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The local development requirement is observable and testable.
...
Keep implementation work focused on one local development outcome and record follow-up improvements separately.