...
Define the offline behavior standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The offline behavior requirement is observable and testable.
...
Keep implementation work focused on one offline behavior outcome and record follow-up improvements separately.