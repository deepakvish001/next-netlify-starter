...
Define the heading hierarchy standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The heading hierarchy requirement is observable and testable.
...
Keep implementation work focused on one heading hierarchy outcome and record follow-up improvements separately.