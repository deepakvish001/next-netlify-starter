...
Define the content security policy standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The content security policy requirement is observable and testable.
...
Keep implementation work focused on one content security policy outcome and record follow-up improvements separately.