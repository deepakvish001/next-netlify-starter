...
Define the theme contract standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The theme contract requirement is observable and testable.
...
Keep implementation work focused on one theme contract outcome and record follow-up improvements separately.