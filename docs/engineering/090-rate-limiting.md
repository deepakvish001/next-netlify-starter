...
Define the rate limiting standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The rate limiting requirement is observable and testable.
...
Keep implementation work focused on one rate limiting outcome and record follow-up improvements separately.