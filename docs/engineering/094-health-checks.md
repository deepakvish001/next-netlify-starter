...
Define the health checks standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The health checks requirement is observable and testable.
...
Keep implementation work focused on one health checks outcome and record follow-up improvements separately.