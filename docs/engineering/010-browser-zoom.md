...
Define the browser zoom standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The browser zoom requirement is observable and testable.
...
Keep implementation work focused on one browser zoom outcome and record follow-up improvements separately.