...
Define the structured data standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The structured data requirement is observable and testable.
...
Keep implementation work focused on one structured data outcome and record follow-up improvements separately.