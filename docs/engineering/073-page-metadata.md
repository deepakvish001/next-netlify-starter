...
Define the page metadata standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The page metadata requirement is observable and testable.
...
Keep implementation work focused on one page metadata outcome and record follow-up improvements separately.