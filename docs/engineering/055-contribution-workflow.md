...
Define the contribution workflow standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The contribution workflow requirement is observable and testable.
...
Keep implementation work focused on one contribution workflow outcome and record follow-up improvements separately.