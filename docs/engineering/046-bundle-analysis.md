...
Define the bundle analysis standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The bundle analysis requirement is observable and testable.
...
Keep implementation work focused on one bundle analysis outcome and record follow-up improvements separately.