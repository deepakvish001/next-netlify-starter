...
Define the cypress fixtures standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The cypress fixtures requirement is observable and testable.
...
Keep implementation work focused on one cypress fixtures outcome and record follow-up improvements separately.