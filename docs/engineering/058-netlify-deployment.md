...
Define the netlify deployment standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The netlify deployment requirement is observable and testable.
...
Keep implementation work focused on one netlify deployment outcome and record follow-up improvements separately.