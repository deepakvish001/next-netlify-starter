...
Define the visual regression standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The visual regression requirement is observable and testable.
...
Keep implementation work focused on one visual regression outcome and record follow-up improvements separately.