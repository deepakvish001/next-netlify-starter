...
Define the formatting standard standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The formatting standard requirement is observable and testable.
...
Keep implementation work focused on one formatting standard outcome and record follow-up improvements separately.