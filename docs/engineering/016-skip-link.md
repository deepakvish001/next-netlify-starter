...
Define the skip link standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The skip link requirement is observable and testable.
...
Keep implementation work focused on one skip link outcome and record follow-up improvements separately.