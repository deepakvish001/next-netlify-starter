...
Define the web vitals standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The web vitals requirement is observable and testable.
...
Keep implementation work focused on one web vitals outcome and record follow-up improvements separately.