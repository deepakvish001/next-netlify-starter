...
Define the static generation standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The static generation requirement is observable and testable.
...
Keep implementation work focused on one static generation outcome and record follow-up improvements separately.