...
Define the live regions standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The live regions requirement is observable and testable.
...
Keep implementation work focused on one live regions outcome and record follow-up improvements separately.