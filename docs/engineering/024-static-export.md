...
Define the static export standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The static export requirement is observable and testable.
...
Keep implementation work focused on one static export outcome and record follow-up improvements separately.