...
Define the empty states standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The empty states requirement is observable and testable.
...
Keep implementation work focused on one empty states outcome and record follow-up improvements separately.