...
Define the cache strategy standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The cache strategy requirement is observable and testable.
...
Keep implementation work focused on one cache strategy outcome and record follow-up improvements separately.