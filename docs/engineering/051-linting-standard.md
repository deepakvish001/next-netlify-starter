...
Define the linting standard standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The linting standard requirement is observable and testable.
...
Keep implementation work focused on one linting standard outcome and record follow-up improvements separately.