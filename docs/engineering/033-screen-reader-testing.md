...
Define the screen reader testing standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The screen reader testing requirement is observable and testable.
...
Keep implementation work focused on one screen reader testing outcome and record follow-up improvements separately.