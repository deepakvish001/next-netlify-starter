...
Define the image optimization standard for LaunchEdge so Next.js changes remain testable, deployable on Netlify, and easy to review.
...
- The image optimization requirement is observable and testable.
...
Keep implementation work focused on one image optimization outcome and record follow-up improvements separately.